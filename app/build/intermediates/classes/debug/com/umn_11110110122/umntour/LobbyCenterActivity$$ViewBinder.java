...
public class LobbyCenterActivity$$ViewBinder<T extends com.umn_11110110122.umntour.LobbyCenterActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131492971, "method 'btnNavTopLeft'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
        ) {
          target.btnNavTopLeft();
        }
      });
    ...
    view = finder.findRequiredView(source, 2131492975, "method 'btnNavTop2'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    target.label_lobby_left = res.getString(2131099683);
    target.label_lobby_right = res.getString(2131099684);
  }
