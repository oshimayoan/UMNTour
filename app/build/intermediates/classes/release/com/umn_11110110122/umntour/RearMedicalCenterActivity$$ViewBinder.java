...
public class RearMedicalCenterActivity$$ViewBinder<T extends com.umn_11110110122.umntour.RearMedicalCenterActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131492980, "method 'btnNavBottomRight'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
        ) {
          target.btnNavBottomRight();
        }
      });
